...
APP_ID = int(os.environ.get("APP_ID", "37371391"))
API_HASH = os.environ.get("API_HASH", "37895f967d284f6781f99e9beef21ebf")
 
BAN = int(os.environ.get("BAN", "1198543450")) #Owner user id
OWNER = os.environ.get("OWNER", "XSUPPRT4BOT") #Owner username
OWNER_ID = int(os.environ.get("OWNER_ID", "7437503888")) #Owner user id
...
CHANNEL_ID = int(os.environ.get("CHANNEL_ID", "-1003806568021")) #database save channel id
...
try:
    ADMINS=[7246766108]
    for x in (os.environ.get("ADMINS", "1198543451 6020516635 6860316927 1837294444 6695586027").split()):
        ADMINS.append(int(x))
except ValueError:
